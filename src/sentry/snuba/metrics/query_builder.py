...
from sentry.snuba.metrics.fields import DERIVED_METRICS, metric_object_factory, DerivedMetric
from sentry.snuba.metrics.utils import (
    ...
    TS_COL_QUERY,
    UNIT_TO_TYPE,
    TimeRange, DerivedMetricParseException,
)
...
def parse_field(field: str) -> Tuple[Optional[str], str]:
    ...
    try:
        ...
        if metric_name in DERIVED_METRICS and isinstance(DERIVED_METRICS[metric_name], DerivedMetric):
